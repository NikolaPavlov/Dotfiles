...
DELIM='####################'
alias sync='task sync && echo "$DELIM" && cd ~/Documents/Repos/Dotfiles && git add . && git commit -m "up" && git push && echo "$DELIM"  && cd ~/Documents/Repos/Wiki && git add . && git commit -m "up" && git push'
