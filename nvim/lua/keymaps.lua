...
-- File navigations
map("n", "<leader>s", function() require("mini.starter").open() end, { desc = "Open MiniStarter" })
...
map("n", "<leader>z", function()
  ...
  if ok and telescope.extensions.zoxide then
    telescope.extensions.zoxide.list()
  else
    vim.notify("telescope-zoxide is not loaded", vim.log.levels.WARN)
  end
